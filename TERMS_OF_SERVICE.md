...
- **Minecraft Player Lookups (`/minecraftinfo`)**: Retrieves publicly available profile information, UUIDs, skin textures, and renders from official Mojang APIs and PlayerDB.
