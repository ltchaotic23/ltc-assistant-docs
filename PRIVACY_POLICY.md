...
* **Google Gemini API**: When you use `/ask` or `/connectpeople`, your input text is transmitted to Google's Gemini API (`gemini-3.6-flash`) to generate a response. Queries sent to Google are subject to Google's Privacy Policy. We do not save your prompts or generated responses to permanent files.
